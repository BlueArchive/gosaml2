...
import (
	...
	"github.com/bluearchive/gosaml2/uuid"
)
...
// Addition to help use-cases for HTTP-PORT bindings
//
// We just want the form field values that we populate
// into our own auto-post UI page
func (sp *SAMLServiceProvider) BuildAuthBodyPostFieldValues(relayState string) (string, string, error) {
	var doc *etree.Document
	var err error
	...
	encodedReq := base64.StdEncoding.EncodeToString(reqBuf)

	return encodedReq, relayState, nil
}
